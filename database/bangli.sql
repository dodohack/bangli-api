...
CREATE TABLE IF NOT EXISTS `bangli`.`posts` (
  ...
  `status` VARCHAR(15) NOT NULL COMMENT '文章状态: 发布,草稿,待审,回收站, publish, draft, pending, trash',
...
CREATE TABLE IF NOT EXISTS `bangli`.`topics` (
  ...
  `featured` TINYINT(1) NULL,
  `status` VARCHAR(15) NOT NULL COMMENT '状态: 发布,草稿,待审,回收站, publish, draft, pending, trash',
...
CREATE INDEX `fk_topic_cat_id_idx` ON `bangli`.`topic_has_category` (`cat_id` ASC);
...
CREATE TABLE IF NOT EXISTS `bangli`.`pages` (
  ...
  `status` VARCHAR(15) NOT NULL COMMENT '页面状态: 发布,草稿,待审,回收站, publish, draft, pending, trash',
...
-- -----------------------------------------------------
-- Table `bangli`.`offer_has_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bangli`.`offer_has_category` ;

CREATE TABLE IF NOT EXISTS `bangli`.`offer_has_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `offer_id` INT NOT NULL,
  `cat_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_ohc_offer_id`
    FOREIGN KEY (`offer_id`)
    REFERENCES `bangli`.`offers` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ohc_cat_id`
    FOREIGN KEY (`cat_id`)
    REFERENCES `bangli`.`categories` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'The relationship between an offer and a category, an offer can belong to multiple categories';

CREATE INDEX `fk_ohc_cat_id_idx` ON `bangli`.`offer_has_category` (`cat_id` ASC);

CREATE INDEX `fk_ohc_offer_id_idx` ON `bangli`.`offer_has_category` (`offer_id` ASC);

USE `bangli` ;

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_topic_has_topic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_topic_has_topic` (`id` INT, `channel_id` INT, `topic1_id` INT, `topic2_id` INT, `t2_title` INT, `t2_guid` INT, `t2_tracking_url` INT, `t2_type_id` INT, `t2_ranking` INT, `t2_type_slug` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_editors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_editors` (`id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_authors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_authors` (`id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_attr_categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_attr_categories` (`id` INT, `channel_id` INT, `parent_id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_attr_topics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_attr_topics` (`id` INT, `channel_id` INT, `type_id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_attr_topic_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_attr_topic_types` (`id` INT, `channel_id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_attr_channels`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_attr_channels` (`id` INT, `slug` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_attr_locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_attr_locations` (`id` INT, `level` INT, `parent_id` INT, `text` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_attr_channels`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_attr_channels` (`id` INT, `slug` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_attr_locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_attr_locations` (`id` INT, `level` INT, `parent_id` INT, `name` INT, `slug` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_attr_topic_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_attr_topic_types` (`id` INT, `slug` INT, `name` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_attr_categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_attr_categories` (`id` INT, `parent_id` INT, `name` INT, `slug` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_posts` (`id` INT, `editor_id` INT, `author_id` INT, `image_id` INT, `channel_id` INT, `location_id` INT, `lock` INT, `featured` INT, `status` INT, `title` INT, `excerpt` INT, `content` INT, `internal_note` INT, `extra` INT, `published_at` INT, `created_at` INT, `updated_at` INT, `view` INT, `word_count` INT, `share` INT, `comment` INT, `upvote` INT, `downvote` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_topic_has_post`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_topic_has_post` (`id` INT, `topic_id` INT, `post_id` INT, `title` INT, `published_at` INT, `view` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_related_topic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_related_topic` (`id` INT, `topic_id` INT, `cat_id` INT, `type_id` INT, `title` INT, `guid` INT, `ranking` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_topics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_topics` (`id` INT, `author_id` INT, `editor_id` INT, `channel_id` INT, `type_id` INT, `location_id` INT, `lock` INT, `logo` INT, `ranking` INT, `featured` INT, `status` INT, `guid` INT, `display_url` INT, `tracking_url` INT, `aff_platform` INT, `aff_id` INT, `title` INT, `title_cn` INT, `description` INT, `content` INT, `published_at` INT, `created_at` INT, `updated_at` INT, `ch_slug` INT, `tt_slug` INT, `view` INT, `word_count` INT, `share` INT, `comment` INT, `upvote` INT, `downvote` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_offers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_offers` (`id` INT, `author_id` INT, `channel_id` INT, `status` INT, `featured` INT, `title` INT, `content` INT, `tracking_url` INT, `display_url` INT, `vouchers` INT, `aff_offer_id` INT, `starts` INT, `ends` INT, `created_at` INT, `updated_at` INT, `published_at` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`view_topic_has_offer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`view_topic_has_offer` (`id` INT, `topic_id` INT, `offer_id` INT, `title` INT, `published_at` INT);

-- -----------------------------------------------------
-- Placeholder table for view `bangli`.`fe_view_simple_topics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bangli`.`fe_view_simple_topics` (`id` INT, `guid` INT, `logo` INT, `title` INT, `title_cn` INT);

-- -----------------------------------------------------
-- View `bangli`.`view_topic_has_topic`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_topic_has_topic` ;
DROP TABLE IF EXISTS `bangli`.`view_topic_has_topic`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `view_topic_has_topic` AS
...
-- -----------------------------------------------------
-- View `bangli`.`view_editors`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_editors` ;
DROP TABLE IF EXISTS `bangli`.`view_editors`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `view_editors` AS
SELECT `id`, `display_name` AS `text` FROM `users` WHERE `role_id` in (1,2,3);

-- -----------------------------------------------------
-- View `bangli`.`view_authors`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_authors` ;
DROP TABLE IF EXISTS `bangli`.`view_authors`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `view_authors` AS
SELECT `id`, `display_name` AS `text` FROM `users` WHERE `role_id` in (1,2,3,4);

-- -----------------------------------------------------
-- View `bangli`.`view_attr_categories`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_attr_categories` ;
DROP TABLE IF EXISTS `bangli`.`view_attr_categories`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `view_attr_categories` AS
SELECT `id`, `channel_id`, `parent_id`, `name` as `text` FROM `categories`;

-- -----------------------------------------------------
-- View `bangli`.`view_attr_topics`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_attr_topics` ;
DROP TABLE IF EXISTS `bangli`.`view_attr_topics`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `view_attr_topics` AS
SELECT `id`, `channel_id`, `type_id`, `title` as `text` FROM `topics`;

-- -----------------------------------------------------
-- View `bangli`.`view_attr_topic_types`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_attr_topic_types` ;
DROP TABLE IF EXISTS `bangli`.`view_attr_topic_types`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `view_attr_topic_types` AS
SELECT `id`, `channel_id`, `name` AS `text` FROM `topic_types`;

-- -----------------------------------------------------
-- View `bangli`.`view_attr_channels`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_attr_channels` ;
DROP TABLE IF EXISTS `bangli`.`view_attr_channels`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `view_attr_channels` AS
SELECT `id`, `slug`, `name` as `text` FROM `channels`;

-- -----------------------------------------------------
-- View `bangli`.`view_attr_locations`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_attr_locations` ;
DROP TABLE IF EXISTS `bangli`.`view_attr_locations`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `view_attr_locations` AS
SELECT `id`, `level`, `parent_id`, `name` as `text` FROM `locations`;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_attr_channels`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_attr_channels` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_attr_channels`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_attr_channels` AS
SELECT `id`, `slug`, `name` FROM `channels`;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_attr_locations`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_attr_locations` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_attr_locations`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_attr_locations` AS
SELECT `id`, `level`, `parent_id`, `name`, `slug` FROM `locations`;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_attr_topic_types`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_attr_topic_types` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_attr_topic_types`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_attr_topic_types` AS
SELECT `id`,  `slug`, `name` FROM `topic_types`;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_attr_categories`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_attr_categories` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_attr_categories`;
USE `bangli`;
-- Used as attributes for post, topic etc.
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_attr_categories` AS
SELECT `id`, `parent_id`, `name`, `slug` FROM `categories`;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_posts`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_posts` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_posts`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_posts` AS
...
-- -----------------------------------------------------
-- View `bangli`.`view_topic_has_post`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_topic_has_post` ;
DROP TABLE IF EXISTS `bangli`.`view_topic_has_post`;
USE `bangli`;
-- View used to quick sort posts of a topic
CREATE  OR REPLACE algorithm = merge VIEW `view_topic_has_post` AS
...
-- -----------------------------------------------------
-- View `bangli`.`fe_view_related_topic`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_related_topic` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_related_topic`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_related_topic` AS
...
-- -----------------------------------------------------
-- View `bangli`.`fe_view_topics`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_topics` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_topics`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_topics` AS
...
-- -----------------------------------------------------
-- View `bangli`.`fe_view_offers`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_offers` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_offers`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `fe_view_offers` AS
SELECT o.*
FROM offers AS o
WHERE o.`status` = 'publish';

-- -----------------------------------------------------
-- View `bangli`.`view_topic_has_offer`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`view_topic_has_offer` ;
DROP TABLE IF EXISTS `bangli`.`view_topic_has_offer`;
USE `bangli`;
CREATE  OR REPLACE algorithm = merge VIEW `view_topic_has_offer` AS
SELECT tho.id, tho.topic_id, tho.offer_id, o.title, o.published_at
FROM topic_has_offer AS tho
INNER JOIN offers AS o ON o.id = tho.offer_id;

-- -----------------------------------------------------
-- View `bangli`.`fe_view_simple_topics`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `bangli`.`fe_view_simple_topics` ;
DROP TABLE IF EXISTS `bangli`.`fe_view_simple_topics`;
USE `bangli`;
-- FIXME: Merge view_attr_topics.
CREATE  OR REPLACE VIEW `fe_view_simple_topics` AS
SELECT t.id, t.guid, t.logo, t.title, t.title_cn
FROM topics AS t
WHERE t.`status` = 'publish';
